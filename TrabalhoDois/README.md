...
--filename é um argumento opcional com o nome do arquivo que será criado com os títulos de notícias, caso não seja passado, os títulos serão impressos na tela.